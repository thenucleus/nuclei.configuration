...
The `Nuclei.Configuration` assembly contains a set of classes and interfaces for handling configurations.


# Installation instructions
All libraries are available on [NuGet.org](https://www.nuget.org/packages/Nuclei.Configuration/).
